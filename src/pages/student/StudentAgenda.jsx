...
const StudentAgenda = () => {
  ...
  const bySchedule = sessions.filter((s) => enrolledIds.includes(s.courseId?.toString()));
  const filtered = bySchedule.filter((s) => courseFilter === 'all' || s.courseId?.toString() === courseFilter);
